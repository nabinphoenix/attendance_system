...
const features = [
  { icon: "◌", title: "Attendance without friction", copy: "Check in with a secure, time-bound QR flow designed for Nepali college campuses." },
  { icon: "▦", title: "One clear academic view", copy: "Keep routines, rooms, classes and attendance clear for colleges across Nepal." },
  { icon: "↗", title: "Support before it is urgent", copy: "Help Nepali students get timely support before attendance becomes a concern." },
];
  ...
  return <main className="landing">
    ...
    <section className="landing-hero">
      <div className="landing-hero-copy">
        ...
        <p className="landing-lede">AntimBench gives students, teachers, and college teams across Nepal one thoughtful place to manage attendance, routines, and early academic support.</p>
        ...
        <div className="landing-trust" aria-label="Key benefits"><span>Role-based access</span><span>Mobile-ready check-in</span><span>Built for Nepali colleges</span></div>
      </div>
      ...
      <div className="landing-preview" aria-label="AntimBench dashboard preview">
        ...
        <div className="landing-preview-inner">
          <div className="landing-preview-top"><p>Thursday, 27 August 2026</p><h2>Good morning, Sita</h2></div>
          <div className="landing-preview-grid">
            ...
            <div className="landing-classes">
              ...
              <div className="landing-class"><span>13:00 · Web Technology</span><span>Room A-204</span></div>
              <div className="landing-class"><span>15:00 · Project Lab</span><span>Lab 3</span></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="landing-stats" aria-label="Platform highlights">
      <div className="landing-stat"><strong>One workspace</strong><span>For Nepali students, teachers and staff</span></div>
      <div className="landing-stat"><strong>QR + location</strong><span>Reliable attendance for Nepal</span></div>
      <div className="landing-stat"><strong>Early insight</strong><span>Support students across Nepal</span></div>
    </section>
