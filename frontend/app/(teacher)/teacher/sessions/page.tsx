...
const MAX_GEOFENCE_RADIUS_METERS = 2000;
...
export default function Page() {
  ...
  function getSessionSettings() {
    ...
    if (!Number.isFinite(boundary) || boundary <= 0 || boundary > MAX_GEOFENCE_RADIUS_METERS) {
      setError("Campus boundary must be between 1 and " + MAX_GEOFENCE_RADIUS_METERS + " meters.");
      return null;
    }
