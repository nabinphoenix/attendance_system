...
export default function Page() {
  ...
  return <div>
    ...
    {message && <SystemFeedback className="mb-4" tone="success" title="Attendance updated" description={message} />}
