...
export default function Page() {
  ...
  return <div className="max-w-7xl">
    ...
    <section className="mt-7" aria-labelledby="catalog-list-title">
      ...
      {loading ? <LoadingState label="Loading course catalog" /> : <div className="table-wrap"><table><thead><tr><th>Course code</th><th>Course name</th><th>Credits</th><th>Catalog semester</th><th>Assignment status</th><th><span className="sr-only">Actions</span></th></tr></thead><tbody>
