...
const navigation: Record<Role, NavGroup[]> = {
  ...
  teacher: [{ label: "Teaching", items: [{ label: "Today & timetable", href: "/teacher/sessions", icon: "calendar" }, { label: "Room availability", href: "/teacher/room-availability", icon: "building" }, { label: "Manual attendance", href: "/teacher/attendance", icon: "people" }, { label: "Attendance analysis", href: "/teacher/analysis", icon: "chart" }] }],
  student: [{ label: "My college", items: [{ label: "Dashboard", href: "/student/dashboard", icon: "dashboard" }, { label: "My routine", href: "/student/routine", icon: "calendar" }, { label: "Room availability", href: "/student/room-availability", icon: "building" }, { label: "Check in", href: "/student/check-in", icon: "qr" }, { label: "Attendance reports", href: "/student/reports", icon: "chart" }] }],
