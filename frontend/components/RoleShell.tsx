...
const navigation: Record<Role, NavGroup[]> = {
  ...
  admin: [
    ...
    { label: "Academic", items: [{ label: "Semester resources", href: "/admin/academic/semester-resources", icon: "file" }, { label: "Programs", href: "/admin/academic/programs", icon: "book" }, { label: "Batches", href: "/admin/academic/batches", icon: "book" }, { label: "Intakes", href: "/admin/academic/intakes", icon: "book" }, { label: "Sections", href: "/admin/academic/sections", icon: "book" }, { label: "Modules", href: "/admin/academic/modules", icon: "book" }, { label: "Module offerings", href: "/admin/academic/module-offerings", icon: "book" }, { label: "Rooms", href: "/admin/academic/rooms", icon: "building" }, { label: "Time slots", href: "/admin/academic/time-slots", icon: "calendar" }, { label: "Class types", href: "/admin/academic/class-types", icon: "book" }] },
