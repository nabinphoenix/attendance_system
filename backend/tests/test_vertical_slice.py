...
def test_full_attendance_vertical_slice():
    ...
    checked=client.post("/api/v1/check-ins/confirm",headers=student_headers,json={"verification_token":scanned.json()["verification_token"]});assert checked.status_code==200,checked.text
