...
from app.modules.academic.models import Batch,Program,Section,Subject,Teacher
...
def test_mixed_csv_import_and_login():
    ...
    assert client.post("/api/v1/auth/login",json={"email":"valid@example.com","password":"Welcome123!"}).status_code==200
    app.dependency_overrides.clear()
