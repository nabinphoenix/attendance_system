...
class SessionGeofenceCapture(BaseModel):
 ...
 latitude:float=Field(ge=-90,le=90);longitude:float=Field(ge=-180,le=180);accuracy_meters:float=Field(ge=0);geofence_radius_meters:float|None=Field(default=None,gt=0);self_checkin_window_minutes:int|None=Field(default=None,ge=1,le=240);challenge_rotation_seconds:int|None=Field(default=None,ge=15,le=300)
