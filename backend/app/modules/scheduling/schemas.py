...
class ClassSessionRead(ORM):
 ...
 geofence_radius_meters:float|None=None;teacher_location_accuracy_meters:float|None=None;geofence_captured_at:datetime|None=None;self_checkin_window_minutes:int|None=None;challenge_rotation_seconds:int|None=None
