...
class SessionGeofenceCapture(BaseModel):
 ...
 latitude:float=Field(ge=-90,le=90);longitude:float=Field(ge=-180,le=180);accuracy_meters:float=Field(ge=0);geofence_radius_meters:float|None=Field(default=None,gt=0,le=5000);self_checkin_window_minutes:int|None=Field(default=None,ge=1,le=240);challenge_rotation_seconds:int|None=Field(default=None,ge=15,le=300)
class ClassSessionRead(ORM):
 ...
 geofence_radius_meters:float|None=None;teacher_location_accuracy_meters:float|None=None;geofence_captured_at:datetime|None=None;self_checkin_window_minutes:int|None=None;challenge_rotation_seconds:int|None=None;teacher_ip_status:str|None=None
