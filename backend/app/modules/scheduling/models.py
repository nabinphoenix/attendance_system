...
class ClassSession(Base):
    __tablename__="class_sessions";__table_args__=(UniqueConstraint("timetable_entry_id","session_date",name="uq_session_entry_date"),Index("ix_class_sessions_routine_entry_id","routine_entry_id"),CheckConstraint("routine_entry_id IS NOT NULL OR timetable_entry_id IS NOT NULL",name="ck_class_sessions_schedule_source"),)
